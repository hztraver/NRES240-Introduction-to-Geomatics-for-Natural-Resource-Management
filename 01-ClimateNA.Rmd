...
Use the measure tool from the top ribbon (**Map -> Measure**) to measure the length and width of the ellipses at the poles and at the equator. You will notice that the ellipses are actually circles with a diameter of ~993km. They are also spaced at equal intervals of lat/long from each other. 

##### Q5. What areas of the map show the most distortion? What properties of the circles are distorted? Provide info about area, shape, direction & distance.
...
Compare the following three projections: **Mercator (world), Equidistant Cylindrical (world), North Pole Azimuthal Equidistant (world).** 

##### Q6:For each projection what properties of the circles are mostly maintained and what properties are greatly distorted? Provide info about area, shape, direction & distance. (Remember these properties can vary independently in the X and Y dimensions). 

##### Q7: For each scenario idenitfy the best map projection: 1) Comparing the area of differenct countries in the northern hemispherec, 2) Calculating the distance between Edmonton and the north pole , 3) Mapping the shape of the northern Canadian coastline? 
...
##### Q8: In 1-2 sentences comment on the pattern of change in MAT. Where are the greatest changes expected in Canada? 
...
##### Q9: What is the minimum and maximum change in MAP (in units of mm)? 

##### Q10: In 1-2 sentences comment on the pattern of change in MAP. Where are the greatest changes expected in Canada?
